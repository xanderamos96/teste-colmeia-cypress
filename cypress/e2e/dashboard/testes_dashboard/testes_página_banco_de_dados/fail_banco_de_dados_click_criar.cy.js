describe('Click no botão de criar banco de dados', () => {
  ...
  it('Validar se o sistema exibe mensagem de erro ao tentar criar banco de dados sem preencher o nome', () => {
   ...
   cy.url()
    ...
    // Validação se exibe mensagem de erro ao tentar criar banco de dados sem preencher o nome
      ...
      cy.log('Teste validado com sucesso: O sistema exibe mensagem de erro ao tentar criar banco de dados sem preencher o nome')
