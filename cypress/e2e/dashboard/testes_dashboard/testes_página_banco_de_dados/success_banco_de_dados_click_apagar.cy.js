describe('Click no botão de apagar banco de dados', () => {
  ...
  it('Deve permitir apagar um banco de dados existente', () => {
   ...
   cy.url()
    ...
    // Validação do botão de apagar banco de dados
      cy.xpath('/html/body/app-root/ng-component/div/div/ng-component/ng-component/table/tbody/tr/td[3]/div/button[1]')
      .should('exist')
      .should('be.visible')
      .click()

     // Validação se o banco de dados foi apagado
      cy.contains('Teste Cypress')
      .should('not.exist')
      

      cy.log('Banco de dados apagado com sucesso!')
